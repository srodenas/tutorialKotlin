package com.pmdm.virgen.tutorial
...
import com.pmdm.virgen.tutorial.encapsulamiento.VisibilidadPersona
import com.pmdm.virgen.tutorial.encapsulamiento.VisibilidadPersonaPrivada
import com.pmdm.virgen.tutorial.encapsulamiento.VisibilidadPersonaPrivada2
import com.pmdm.virgen.tutorial.encapsulamiento.VisibilidadPersonaPrivada3
import com.pmdm.virgen.tutorial.extensiones.changeToUpper
import com.pmdm.virgen.tutorial.extensiones.formatSize
import com.pmdm.virgen.tutorial.extensiones.myFormat
import com.pmdm.virgen.tutorial.funciones.devuelveSumaArray
import com.pmdm.virgen.tutorial.funciones.devuelveSumaArray2
import com.pmdm.virgen.tutorial.herencia.*
import com.pmdm.virgen.tutorial.herencia_simple.*
...
import com.pmdm.virgen.tutorial.interfaces.SeleccionFutbol as SeleccionFutbolInterface
import com.pmdm.virgen.tutorial.interfaces.Entrenador as EntrenadorInterface
import com.pmdm.virgen.tutorial.interfaces.Jugador as JugadorInterface

//TypeAlias para crearnos nuestros propios tipos.
typealias MyTypesDepartaments = MutableMap<Int, ArrayList<String>>  //Creo un tipo para Map
typealias myTypeOperation = (Int, Int) -> Int   //Creo un tipo de función
typealias myClassOperation = Calculadora.Operacion  //Creo un tipo para una clase interna.
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //pruebaMetodos() //Prueba todos los métodos hasta funciones.
        //probarFunciones()  //Prueba las funciones
        //pruebaClasesIniciales()
        //pruebaClasesIniciales1()
        //pruebaClasesIniciales2()
        //pruebaClases()  //Prueba las Clases Persona, Persona2 y Persona3
        //pruebaClasesAnidadas()  //Prueba clases anidadas e internas
        //pruebaVisibilidad()
        //pruebaHerencia()
        //probarPolimorfismo()
        //probarInterfaces()
    ...
    private fun pruebaMetodos(){
        /*
        repaso kotlin tipo de datos (tipoDeDatos)
         */
        //tipoDeDatos()
        /*
        repaso kotlin sentencia if
         */
        //sentenciaIfElse()

        /*
        repaso kotlin sentencia when
         */
        //sentenciaWhen()
        ...
        /*
        repaso de diccionarios en kotlin. Son muy utilizados sobre todo el python
         */
        //diccionarios()

        /*
        repaso de bucles loop en kotlin.
         */

        //bucles()

        /*
        repaso de como controlar nullPointerException. nullSafety
         */
        //nullPointer()
    }
    ...
    private fun listas() {
        ...
        1. La interfa List, implementa sólo lectura cuando se inicializa con listOf y será de lectura/escritura
        ...
        una colección inmutable. Por tanto, no utilizaremos la interfaz List, cuando queramos dinamizidad.
    ...
    private fun diccionarios(){
        //Igual los conocemos como maps o HashMap en Java.
        /*
    ...
    private fun nullPointer(){
        ...
        2.- Ahora, kotlin mostrará mull cuando el valor sea null. No generará la exceptión.
        ...
        /*
        Para obligar a una variable Safety que no sea nula, pondremos el !!. No lo utilizaremos.
         */
    ...
    //Método que prueba el fichero de funciones myFunctions
    private fun probarFunciones(){
        //primeraFuncion()
    ...
    */
    ...
    private fun pruebaClasesIniciales2(){
        ...
        // val per3 = PersonaGetSet1() No podríamos llamar al constructor sin ningún parametro.
    ...
    private fun pruebaClases(){
        ...
        var per5 = Persona3("David", 30,  arrayOf(
            Persona3.Jobs.Programador, Persona3.Jobs.Ingeniero, Persona3.Jobs.Investigador_a
        ), arrayOf(
            per4
 ...
 */
    ...
    private fun pruebaVisibilidad(){
        val myPerson = VisibilidadPersona()
        myPerson.name = "santi"
        myPerson.myName()

        val myPrivatePerson = VisibilidadPersonaPrivada()
        myPrivatePerson.name = "santi"
        myPrivatePerson.exchangeUpperOLower(true)
        print("Datos: $myPrivatePerson  ")
        myPrivatePerson.stateName()
        myPrivatePerson.exchangeUpperOLower(false)
        print("Datos: $myPrivatePerson  ")
        myPrivatePerson.stateName()
        myPrivatePerson.exchangeUpperOLower(true)
        print("Datos: $myPrivatePerson  ")
        ...
        //Probamos las protected
        val myPrivatePerson2 = VisibilidadPersonaPrivada2()
        //Desde myPrivatePerson2, no puedo acceder al método protected, ya que es privado desde fuera.
        //Ahora probaremos a crearnos un objeto de una subclase de BisibilidadPersonaPrivada2, con método publico
        val myPrivatePerson3 = VisibilidadPersonaPrivada3()
        myPrivatePerson3.myNameForPrivada3()
    }

    private fun pruebaHerencia(){


        //val e = SeleccionFutbol()
    ...
    private fun probarInterfaces(){
        ...
        var listIntegrantes : MutableList<IntegranteSeleccionFutbol> = mutableListOf(
            JugadorInterface(1, "Andrés", "Iniesta", 25
                , 9,"central"),
            EntrenadorInterface(3, "Vicente", "Del Bosque", 50, "1234" )
        )
        listIntegrantes.add(JugadorInterface(2, "Santi", "Rodebnas", 20, 5, "defensa"))
    ...
    /*
    Su objetivo es almacenar datos. Nos otorgará sólo operaciones para trabajar con datos.
    Cuando son objetos que sólo queremos representar información de ellas, mejor trabajar con DataClass
    que con Clases. "SÓLO ALMACENAR DATOS". Muchas mas óptimas.

    Nos implementa algunos métodos de manera automática. hashCode, toString, copy, componentN
    ...
    /*
    Interesante los typeAlias, para crearnos nuevos tipos que nos facilite nombres alternativos para tipos que ya existen.
     */
    ...
    private fun probarTypeAlias(){
        ...
        /*
        Imaginar que me quiero crear otro objeto del tipo  MutableMap<Int, ArrayList<String>> = mutableMapOf()
        - Tendría que volver a declararmelo como arriba. Puedo declararme un typeAlias. Para ello me voy al lugar de
        import y declaro con typealias MyTypesDepartaments = MutableMap<Int, ArrayList<String>>
         */
